                ...
                columns: [
                  ...
                  },
                  {
                    ...
                    items: [
                      {
                        type: 'TextBlock',
                        text: config.priorityMap[item.priority] === 1 ? '🔥 High' : item.priority,
                        size: 'Small',
                        color: getPriorityColor(item.priority),
                        weight: config.priorityMap[item.priority] === 1 ? 'Bolder' : 'Default',
                      },
                    ],
                  },
                  {
  ...
  const card = {
        ...
        ? [
            {
              ...
              items: [
                {
                  type: 'TextBlock',
                  text: `Meeting Sentiment: ${sentiment}`,
                  color: sentiment === 'Positive' ? 'Good' : sentiment === 'Negative' ? 'Attention' : 'Default',
                  weight: 'Bolder',
                  size: 'Small',
                },
              ],
    ...
    actions: [
      ...
      },
      {
        type: 'Action.OpenUrl',
        title: '🐛 Report Issue',
        url: 'https://github.com/JackAmichai/ActionAgent/issues/new',
      },
    ],
  };
 ...
 */
export function createProcessingCard(meetingSubject: string, step?: string): object {
  return {
    type: 'AdaptiveCard',
    $schema: 'http://adaptivecards.io/schemas/adaptive-card.json',
    version: '1.5',
